...
joint.shapes.tm.toolElement = joint.shapes.basic.Generic.extend({
  toolMarkup: [
    ...
    '<g class="element-tool-link"><circle fill="grey" r="11" cx="25"/>',
    ...
    '<g class="element-tool-highlight"><circle fill="#ff8000" r="11" cx="50"/>',
    ...
    '<g class="element-tool-break-connections"><circle fill="#a52a2a" r="11" cx="75"/>',
